...
@Autonomous(name = "NewAutonomousDepo" , group = "Autonomous")
public class NewAutonomousDepo extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        if (detector.isFound() && detector.getXPosition() > 200){
            encoderDrive(0.75,-22,-22,5);
            sleep(1000);
            rotate(-32,.3);
            sleep(1000);
            score(-1300,0.75);
            sleep(1000);
            encoderDrive(0.75,27 ,27,6);
            sleep(1000);
        ...
        //left
            ...
            score(-1300,0.75);
            sleep(1000);
            encoderDrive(0.75,21,21,10);
            encoderDrive(0.25,3,3,10);
            sleep(1000);
            //rotate(-25,0.3);
    ...
    public void down(){
        robot.motorArm.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        robot.motorArm.setTargetPosition(-7500);//2432
        robot.motorArm.setPower(-1);
    }
